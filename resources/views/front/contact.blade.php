...
@section('content')
    ...
    <header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(front/assets/images/fundoSite.jpg);" data-stellar-background-ratio="0.5">
